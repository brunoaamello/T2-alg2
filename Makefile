...
# Project:  t2.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile t2.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = t21.0.0
DISTDIR = /home/bruno/Aulas/alg2/T2-alg2/.tmp/t21.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  
AR            = ar cqs
...
Makefile: t2.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib64/qt5/mkspecs/features/lex.prf \
		t2.pro
	$(QMAKE) -o Makefile t2.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
main.o: main.cpp databroker.h \
		indice.h \
		register.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

databroker.o: databroker.cpp databroker.h \
		indice.h \
		register.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o databroker.o databroker.cpp

indice.o: indice.cpp indice.h \
		register.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o indice.o indice.cpp
